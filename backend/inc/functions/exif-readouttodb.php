...
echo " Dette er bilde fra uploads.php! som er kommet til exif.php!: ".$varabelfromuploads."<br/>";
...
function imageFile($image){
    if((isset($image)) and file_exists($image)){
        ...
        echo "Bilde finnes ikke (fileImage)<br/>";
    }
}
...
function cameraUsed($image)
{
    if ((isset($image)) and (file_exists($image))) {
        ...
        echo "Bilde finnes ikke(cameraUsed)<br/>";
    }
}
...
function imageDetails($image)
{
    ...
    if ((isset($image)) and (file_exists($image))) {
        ...
        echo "Bilde finnes ikke(imageDetail)<br/>";
    }
}
...
function exifDetails($image)
{
    if ((isset($image)) and (file_exists($image))) {
        ...
        echo "Bilde finnes ikke(exifDetail)<br/>";
    }
...
print_r("----------------------------------------"."<br/>");
print_r("IFD0:" . "<br/>");
print_r("Camera Used:" . $camera['Make'] ."<br/>");
print_r("Model:" . $camera['Model'] . "<br />");
