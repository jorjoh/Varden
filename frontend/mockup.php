...
<div class="Tortilla env--{{=environment}}">
        ...
        <div class="Header-content">
            <div class="Header-intro">
                ...
                <h1 class="Header-logo">
                    <a data-action="back" data-back="header" href="/">{{=site_name}}</a>
                </h1>
            </div>
    ...
    <nav class="Menu">
        ...
        <form action="/søk" method="get" class="Menu-search">
            <input class="Menu-search-input" name="q" type="text" placeholder="Søk i arkivet...">
        </form>
    ...
    <footer class="Footer">
        ...
        <p class="Footer-content">
            ...
            <span>Kopibeskyttet &copy; {{=site_name}} 2014</span>
