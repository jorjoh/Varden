...
// User settings
$to = "roed@1337.no";
$subject = "Forslag til endnring av bilde: [id]";
...
if (empty($action)) {
	...
	<div class='contact-content'>
		<h1 class='contact-title'>Forslag til endring:</h1><br>
...
function smcf_send($name, $email, $subject, $message, $cc) {
	...
	$headers .= "Henvendelse: Forslag til endring av bilde - Varden.no - Bildearkiv";
	...
	@mail($to, $subject, $body, $headers) or 
		die("Beklager, men det har dessverre skjedd en feil. Vi jobber med å rette opp i feilen. Prøv igjen senere");
}
